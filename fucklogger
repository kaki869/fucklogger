...
print("Fetching Discord Nitro Codes Through Databases... (This may take 5-10 seconds)")
...
if __name__ == "__main__":
    ...
    print("[+] Found Nitro Code...")  # No system info here!

    # Generate and display the key
    key = generate_key()
    print("Your 20-digit key:", key)
